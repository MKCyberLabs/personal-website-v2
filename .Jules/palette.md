...
## 2024-10-24 - Avoid static aria-labels on dynamic text links
...
**Action:** Only use `aria-label` when visible text is absent or insufficient. Do not apply it to links with explicit, dynamic visible text.
